...
//  public static final String urlCustom = "http://cus.adwhirl.com/custom.php?appid=%s&nid=%s&uuid=%s&country_code=%s%s&appver=%d&client=2";
  ...
  public static final String urlConfig = "http://medad.vpon.com/getInfo.php?appid=%s&appver=%d&client=2";
  public static final String urlImpression = "http://medad.vpon.com/exmet.php?appid=%s&nid=%s&type=%d&uuid=%s&country_code=%s&appver=%d&client=2";
  public static final String urlClick = "http://medad.vpon.com/exclick.php?appid=%s&nid=%s&type=%d&uuid=%s&country_code=%s&appver=%d&client=2";
  public static final String urlCustom = "http://medad.vpon.com/custom.php?appid=%s&nid=%s&uuid=%s&country_code=%s%s&appver=%d&client=2";
  ...
  public static final int NETWORK_TYPE_ADON_TW = 21;
  public static final int NETWORK_TYPE_ADON_CN = 22;
