...
//        Integer keyLength = keyValue.length;
        ...
        do
        {
                ...
                {
                        String strNation = keyValue[0];

                        String strRealKey = keyValue[1];

                        //error check, in case something unexpected happen

                        if (strNation.length() == 0 || strRealKey.length() == 0)
                        {
                                break;
                        }

                        if (strNation.equals("TW"))
                        {
                                ration.type = 21;
                                ration.key = strRealKey;
                                ration.name = "adon_tw";
                        }
                        else if (strNation.equals("CN"))
                        {
                                ration.type = 22;
                                ration.key = strRealKey;
                                ration.name = "adon_cn";
...
//TODO jessy if necessary
      ...
      if(metrics.density >= 2
        ...
        && custom.imageLink640x100 != null
        && custom.imageLink640x100.length() != 0) {
    	  custom.image = fetchImage(custom.imageLink640x100);
