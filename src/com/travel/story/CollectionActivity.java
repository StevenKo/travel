...
public class CollectionActivity extends SherlockFragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTabHost.setBackgroundColor(this.getResources().getColor(R.color.pager_background));
        
        mTabHost.setup(this, getSupportFragmentManager(), R.layout.fragment_tabhost);

        setupTab(CollectionNoteFragment.class, "遊記", "View1");
        setupTab(CollectionSiteFragment.class, "景點", "View2");
    ...
    public void onResume(){
		super.onResume();
		if(mTabHost!=null){			
			int int_page = mTabHost.getCurrentTab();
			mTabHost.clearAllTabs();
			setupTab(CollectionNoteFragment.class, "遊記", "View1");
	        setupTab(CollectionSiteFragment.class, "景點", "View2");
	        mTabHost.setCurrentTab(int_page);
		}		
	}
