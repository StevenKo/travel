...
public class CategoryTravelNoteFragment extends Fragment {
    ...
    private class DownloadChannelsTask extends AsyncTask {
        ...
        protected Object doInBackground(Object... params) {
        	...
        	myNotes = TravelAPI.getNationGroupNotes(groupNationId, myPage, contentOrder);
    ...
    private class LoadMoreTask extends AsyncTask {
        ...
        protected Object doInBackground(Object... params) {
        	...
        	moreNotes.clear();
        	moreNotes = TravelAPI.getNationGroupNotes(groupNationId, myPage, contentOrder);
        	if(moreNotes!= null){
