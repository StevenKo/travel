...
public class LastCategoryBestFragment extends Fragment {
    ...
    public static LastCategoryBestFragment newInstance() {

    	LastCategoryBestFragment fragment = new LastCategoryBestFragment();
