...
public class LastCategoryNewestFragment extends Fragment {
    ...
    public static LastCategoryNewestFragment newInstance() {

    	LastCategoryNewestFragment fragment = new LastCategoryNewestFragment();
